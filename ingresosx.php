...
$sql = "SELECT * FROM ingresosx WHERE (tipo_ingreso LIKE ? OR cliente LIKE ?) $condicion_fecha LIMIT ?, ?";
...
$sql_total = "SELECT COUNT(*) FROM ingresosx WHERE (tipo_ingreso LIKE ? OR cliente LIKE ?) $condicion_fecha";
...
<body>
    ...
    <a href="generar_factura_x.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">Ver Factura</a>
