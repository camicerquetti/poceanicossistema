...
if (isset($_GET['eliminar'])) {
    ...
    if (is_numeric($idCuenta)) {
        ...
        $deleteQuery = "DELETE FROM cuentas WHERE Id_cuenta = $idCuenta";
...
$query = "SELECT Id_cuenta, Cuenta, Tipo, Saldo, Usuario, Categoria FROM cuentas";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insertQuery = "INSERT INTO cuentas (Cuenta, Tipo, Saldo, Usuario, Categoria) 
